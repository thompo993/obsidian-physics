...
Once again \textttt{CrossEntropyLoss} was chosen, although the optimiser chosen was \texttt{AdamW}. This is simply the Adam optimiser with this allows it to decay in a very stable fashion and you want to utilise weight decay and smaller weights without hindering Adams ability to adapt \cite{loshchilovDecoupledWeightDecay2019}. The model was fed two seperate inital learning rates, as the last residual block requires a much smal
