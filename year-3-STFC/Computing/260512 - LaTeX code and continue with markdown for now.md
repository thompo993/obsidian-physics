...
For Resnet 18, the standard input image is identical to that defined above in section \ref{CORRECT SECTION HERE}. This allowed the same data loaders to be used. Resnet 18 has XXXX layers, and to tune it to this specific model the classifier head was adjusted to accommodate this specific classification problem, with . . . 
