...
# Notes:
We want to experiment with three different compression types, split across each of the three system config files. we will have some settings the same (`super_rt-1-1.json`, with only compression mode changing 
