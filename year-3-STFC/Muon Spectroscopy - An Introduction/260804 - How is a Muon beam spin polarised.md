...
When they decay at rest, we know that there is no velocity confounding the spin, and so the spin is antiparralel to its momentum. 
therefore we can select polarised muons
