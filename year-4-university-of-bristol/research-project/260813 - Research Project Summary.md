...
| Units you must take before you take this one (pre-requisite units) | [PHYS30051](https://www.bris.ac.uk/unit-programme-catalogue/UnitDetails.jsa?unitCode=PHYS30051&ayrCode=26/27&orgCode=PHYS) |
...
The project is an opportunity for students to undertake research in physics, either experimental or theoretical, and carry out an investigation, usually associated with one of the research areas in the School. Projects are usually done in pairs. The project is student-led and leads to a substantial report detailing the project, how it was approached, and the results obtained. A research project requires initiative and independence and a diversity of knowledge and skills. This is an opportunity to gain insight into tackling real research problems and acquire research skills including those needed to present your work in different formats.
...
Students will gain insight into tackling real research problems.
...
- Produce a clear and coherent report
...
If you are unable to access a list through Blackboard, you can also find it via the [Resource Lists homepage.](https://bristol.rl.talis.com/index.html) Search for the list by the unit name or code (e.g. PHYSM3406).
